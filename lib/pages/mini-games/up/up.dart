...
class UpGame extends Forge2DGame with KeyboardEvents {
  ...
  Future<void> onLoad() async {
    final camera = CameraComponent.withFixedResolution(width: 1280, height: 720);
...
class _Background extends PositionComponent {
  ...
  void render(Canvas canvas) {
    canvas.drawRect(Rect.fromLTWH(0, 0, size.x, size.y), Paint()..color = const Color.fromARGB(255, 56, 53, 53));
  }
}
